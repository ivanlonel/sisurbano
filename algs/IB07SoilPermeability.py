...
class IB07SoilPermeability(QgsProcessingAlgorithm):
    """
    ...
    def initAlgorithm(self, config):
        ...
        FULL_PATH = buildFullPathName(currentPath, nameWithOuputExtension(NAMES_INDEX['IB07'][1]))            
    ...
    def icon(self):
        return QIcon(os.path.join(pluginPath, 'sisurbano', 'icons', 'green2.jpeg'))
    ...
    def name(self):
        ...
        """
        return 'B07 Permeabilidad del suelo'
