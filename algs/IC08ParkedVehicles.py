...
class IC08ParkedVehicles(QgsProcessingAlgorithm):
    """
    ...
    def initAlgorithm(self, config):
        ...
        FULL_PATH = buildFullPathName(currentPath, nameWithOuputExtension(NAMES_INDEX['IC08'][1]))            
    ...
    def name(self):
        ...
        """
        return 'C08 Espacio público ocupado por vehículos parqueados'
